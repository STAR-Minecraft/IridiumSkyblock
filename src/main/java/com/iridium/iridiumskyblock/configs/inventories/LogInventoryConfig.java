...
public class LogInventoryConfig extends NoItemGUI {
    ...
    public LogInventoryConfig(int size, String title, Background background, Item IslandMembers, Item IslandTrusts, Item IslandInvites, Item IslandBank, Item IslandBoosters, Item IslandUpgrades, Item IslandRewards, String USER_JOINED, String USER_KICKED, String USER_LEFT, String USER_INVITED, String USER_UNINVITED, String USER_PROMOTED, String USER_DEMOTED, String USER_TRUSTED, String USER_UNTRUSTED, String BANK_DEPOSIT, String BANK_WITHDRAW, String BOOSTER_PURCHASE, String UPGRADE_PURCHASE, String REWARD_REDEEMED) {
