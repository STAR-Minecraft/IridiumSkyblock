...
public class Messages {
    ...
    public String shopLimitExceeded = "%prefix% &7Your shop selling limit has exceeded!";
    ...
    public String shopLimitsResetNotNeeded = "%prefix% &7Nothing to reset, your shop counters is default now!";
    public String shopLimitsResetFail = "%prefix% &7You need %crystals% Crystals and $%vault% to perform the shop counters reset!";
    public String shopLimitsResetSuccess = "%prefix% &7Your shop selling limits have been reset for %crystals% Crystals and $%vault%.";
    public String shopLimitsResetAlert = "%prefix% &7Your shop selling limits have been reset automatically!";
