...
public class Inventories {
    ...
    public Item nextPage = new Item(XMaterial.LIME_STAINED_GLASS_PANE, -3, 1, "&a&lNext Page", Collections.emptyList());
    public Item previousPage = new Item(XMaterial.RED_STAINED_GLASS_PANE, -7, 1, "&c&lPrevious Page", Collections.emptyList());
